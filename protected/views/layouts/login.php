...
<div class="row">
<div class="col-md-12" >
<div class="logo logossig" align="center">
                <img src="<?php echo Yii::app()->request->baseUrl;?>/images/logo_df_alta_bn.png" class="img-responsive" />

</div>

 <div class="subtitulo2" align="center">Instituto de Educaci&oacute;n Media Superior del Distrito Federal</div>
