                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="widget widget-table">
                                            <div class="widget-header">
                                                <h3><i class="fa fa-desktop"></i>Reporte de Correspondencia Bandeja de Salida</h3>
                                               
                                                <div class="btn-group widget-header-toolbar">
                                                    <div class="control-inline toolbar-item-group">
                                                      
                                                   <?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/excel.png'),array('apiExcel/Salida?fecha1='.$fecha1.'&fecha2='.$fecha2.'&id_tipo='.$id_tipo.'&area_rem='.$area_rem.'&area_dest='.$area_dest)); ?>
