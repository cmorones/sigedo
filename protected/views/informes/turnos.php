  ...
  directorio.id_area = areas.id';
        ...
        $resultrem=Yii::app()->db->createCommand($query)->queryAll();
         ...
         foreach ($resultrem as $value) {
                    $remitentes[$value['id_area']] = "$value[nombre]";
                }
...
<div class="row">
 <div class="col-md-2">
 <?php  echo CHtml::label('Remitentes','terms'); ?>
 </div>
 <div class="col-md-6">
    <?php 
...
WHERE 
  ...
  directorio.id_dp = datos_personales.id';
        ...
        $resultlist=Yii::app()->db->createCommand($query2)->queryAll();

         $listremitentes['false'] = 'Todos';

         foreach ($resultlist as $value) {
                    $listremitentes[$value['remitente']] = "$value[nombre] $value[apellido_p] $value[apellido_m] - $value[cargo]";
                }
...
WHERE 
  ...
  directorio.id_area = areas.id';
        ...
        $resultrem=Yii::app()->db->createCommand($query)->queryAll();
         ...
         foreach ($resultrem as $value) {
                    $destinatarios[$value['id_area']] = "$value[nombre]";
                }
...
<div class="row">
 <div class="col-md-2">
 <?php  echo CHtml::label('Destinatarios','terms'); ?>
 </div>
 <div class="col-md-6">
    <?php 
...
WHERE 
  ...
  directorio.id_dp = datos_personales.id';
        ...
        $resultlist=Yii::app()->db->createCommand($query2)->queryAll();
         ...
         $listdest['false'] = 'Todos';

         foreach ($resultlist as $value) {
                    $listdest[$value['destinatario']] = "$value[nombre] $value[apellido_p] $value[apellido_m] - $value[cargo]";
                }
...
<div class="row">
 ...
 <div class="col-md-6">
    ...
    $partidas['false'] = "Todos";
    $partidas[0] = "Pendientes";
    $partidas[1] = "Solucionado";
